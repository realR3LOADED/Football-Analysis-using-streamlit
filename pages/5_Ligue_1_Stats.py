...
st.set_page_config(page_title="Ligue 1 Stats Player Wise", page_icon="📈")

st.title("Ligue 1 Player Details")  
...
match a:
    case "14-15":
        df = pd.read_csv('data/ligue1/players_ligue_1_14-15.csv')
    ...
    case "15-16":
        df = pd.read_csv('data/ligue1/players_ligue_1_15-16.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "16-17":
        df = pd.read_csv('data/ligue1/players_ligue_1_16-17.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "17-18":
        df = pd.read_csv('data/ligue1/players_ligue_1_17-18.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "18-19":
        df = pd.read_csv('data/ligue1/players_ligue_1_18-19.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "19-20":
        df = pd.read_csv('data/ligue1/players_ligue_1_19-20.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "20-21":
        df = pd.read_csv('data/ligue1/players_ligue_1_20-21.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "21-22":
        df = pd.read_csv('data/ligue1/players_ligue_1_21-22.csv')
