...
st.set_page_config(page_title="Bundesliga Stats Player Wise", page_icon="📈")

st.title("Bundesliga Player Details")  
...
match a:
    case "14-15":
        df = pd.read_csv('data/bundesliga/players_bundesliga_14-15.csv')
    ...
    case "15-16":
        df = pd.read_csv('data/bundesliga/players_bundesliga_15-16.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "16-17":
        df = pd.read_csv('data/bundesliga/players_bundesliga_16-17.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "17-18":
        df = pd.read_csv('data/bundesliga/players_bundesliga_17-18.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "18-19":
        df = pd.read_csv('data/bundesliga/players_bundesliga_18-19.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "19-20":
        df = pd.read_csv('data/bundesliga/players_bundesliga_19-20.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "20-21":
        df = pd.read_csv('data/bundesliga/players_bundesliga_20-21.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "21-22":
        df = pd.read_csv('data/bundesliga/players_bundesliga_21-22.csv')
