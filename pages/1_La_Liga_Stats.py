...
st.title("LaLiga Player Details")  
...
match a:
    case "14-15":
        df = pd.read_csv('data/laliga/players_la_liga_14-15.csv')
    ...
    case "15-16":
        df = pd.read_csv('data/laliga/players_la_liga_15-16.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "16-17":
        df = pd.read_csv('data/laliga/players_la_liga_16-17.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "17-18":
        df = pd.read_csv('data/laliga/players_la_liga_17-18.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "18-19":
        df = pd.read_csv('data/laliga/players_la_liga_18-19.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "19-20":
        df = pd.read_csv('data/laliga/players_la_liga_19-20.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "20-21":
        df = pd.read_csv('data/laliga/players_la_liga_20-21.csv')
        ...
        if not selected_players.empty:
            ...
            st.write("No players found with the given criteria.")
    case "21-22":
        df = pd.read_csv('data/laliga/players_la_liga_21-22.csv')
